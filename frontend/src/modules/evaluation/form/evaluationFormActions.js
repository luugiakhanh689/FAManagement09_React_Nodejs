...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      Message.success(i18n('entities.evaluation.create.success'));
  ...
  doUpdate: (id, values) => async (
    ...
    try {
      ...
      Message.success(i18n('entities.evaluation.update.success'));
