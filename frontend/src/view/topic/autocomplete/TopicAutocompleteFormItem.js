...
import TopicFormModal from 'view/topic/form/TopicFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/topic/topicSelectors';

class TopicAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return TopicService.listAutocomplete(value, limit);
  };
...
export default connect(select)(TopicAutocompleteFormItem);
