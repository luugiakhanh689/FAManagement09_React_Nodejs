...
function select(state) {
  return {
    ...
    hasPermissionToCreate: courseSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: courseSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(CourseToolbar);
