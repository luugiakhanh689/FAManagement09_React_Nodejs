...
class ClassRoomToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=classRoom">
...
export default connect(select)(ClassRoomToolbar);
