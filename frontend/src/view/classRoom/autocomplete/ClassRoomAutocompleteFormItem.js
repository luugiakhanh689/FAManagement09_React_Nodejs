...
import ClassRoomFormModal from 'view/classRoom/form/ClassRoomFormModal';
...
class ClassRoomAutocompleteFormItem extends Component {
  ...
  fetchFn = (value, limit) => {
    return ClassRoomService.listAutocomplete(value, limit);
  };
...
export default connect(select)(ClassRoomAutocompleteFormItem);
